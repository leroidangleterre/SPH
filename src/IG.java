...
public class IG{
	...
	private TimerTask evolutionTimerTask;
	...
	private class KeyBoardListener implements KeyListener{
		...
		public void keyPressed(KeyEvent e){
			...
			/*
			 * case KeyEvent.VK_P:
			 * this.panneau.setOutilEnCours(Outil.CREATION_PARTICULES);
			 * System.out.println("PARTICULE"); fenetre.setTitle("PARTICULE");
			 * break;
			 */
			case KeyEvent.VK_C:
			...
			case KeyEvent.VK_DELETE:
				...
				break;
			case KeyEvent.VK_ENTER: /* Effectuer un pas d'exécution. */
				world.evoluerManuel(worldPeriod);
				break;
			case KeyEvent.VK_P: /* Play/pause. */
			case KeyEvent.VK_SPACE: /* Play/pause. */
