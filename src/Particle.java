...
public class Particle{
    ...
    public Particle(double xParam, double yParam, double rayonParam, int numLigneParam, int numColonneParam){
        ...
        this.coloredPointList.add(new PointCouleur(4.1, 1, 255, 255, 0)); // yellow
        this.coloredPointList.add(new PointCouleur(4.5, 1, 230, 230, 230)); // gray
        this.coloredPointList.add(new PointCouleur(5, 1, 0, 255, 255)); // light blue
        this.coloredPointList.add(new PointCouleur(5.5, 1, 255, 0, 255)); // violet
        this.coloredPointList.add(new PointCouleur(5.8, 1, 0, 0, 0)); // black
        this.coloredPointList.add(new PointCouleur(6.2, 1, 128, 128, 128)); // gray
...
//			System.out.println("overlap: " + overlap);
            ...
            double value = 0;
//            System.out.println("radius: " + this.radius + ", " + p.radius + ", overlap: " + overlap);
            if(overlap / this.radius < 0.1){
                value = -overlap * 500;
            } else if(overlap / this.radius < 0.5){
                value = -overlap * 1000;
            } else{
                value = -overlap * 3000;
            }
